...
public class PhoneOtpCredentialModel extends CredentialModel {
    ...
    public SmsOtpCredentialData getSmsOtpCredentialData() {
        return smsOtpCredentialData;
    }

    public EmptySecretData getEmptySecretData() {
        return emptySecretData;
    }

    public static PhoneOtpCredentialModel create(String phoneNumber, boolean wechat) {

        SmsOtpCredentialData credentialData = new SmsOtpCredentialData(phoneNumber, wechat);
    ...
    public static class SmsOtpCredentialData {
        ...
        @JsonCreator
        @ConstructorProperties({"phoneNumber", "wechat"})
        SmsOtpCredentialData(String phoneNumber, boolean wechat) {
