...
import org.keycloak.providers.phone.authentication.requiredactions.ConfigSmsWechatOtpRequiredAction;
...
public class SmsWechatOtpMfaAuthenticator implements Authenticator, CredentialValidator<PhoneOtpCredentialProvider> {

    private static final Logger logger = Logger.getLogger(SmsWechatOtpMfaAuthenticator.class);
    ...
    public void setRequiredActions(KeycloakSession session, RealmModel realm, UserModel user) {
        user.addRequiredAction(ConfigSmsWechatOtpRequiredAction.PROVIDER_ID);
    }
