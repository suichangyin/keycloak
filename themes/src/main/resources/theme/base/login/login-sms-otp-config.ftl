    ...
    <#--      <script src="https://cdn.jsdelivr.net/npm/libphonenumber-js@1.11.9/bundle/libphonenumber-js.min.js"></script>-->
        ...
        <div id="vue-app">
            <ul class="nav nav-tabs">
                <li :class="{'active': activeTab === 'phone'}" @click="activeTab = 'phone'">
                    <a href="javascript:void(0);">
                        ${msg("phoneVerification")}
                    </a>
                </li>
                <li v-if="false" :class="{'active': activeTab === 'wechat'}" style="pointer-events: none; cursor: not-allowed; color: gray;" @click="switchToQrCode">
                    <a href="javascript:void(0);" @click.prevent>
                        ${msg("wechatVerification")} - ${msg("disabledMessage")}
                    </a>
                </li>
            </ul>
                        ...
                        <div id="kc-form-wrapper">
                            <form id="kc-form-login" action="${url.loginAction}" method="post">
                                ...
                                <div class="${properties.kcFormGroupClass!} row">
                                    ...
                                    <div id="code-container" style="display: flex; gap: 5px;">
                                        <input type="text" class="otp-input" maxlength="1" v-for="n in 6" :id="'code' + n" :key="n" @input="handleInput($event, n)" @keydown.backspace="handleBackspace($event, n)"/>
                                    </div>
